...
s1 = (normal@left) / 2^(normal@bit - 1)

timearray1 = (0:(294236-1))/normal@samp.rate
...
s2 = (angry@left) / 2^(angry@bit - 1)  

timearray2 = (0:(270951-1))/angry@samp.rate
...
s3 = (exci@left) / 2^(exci@bit - 1)  

timearray3 = (0:(248724-1))/exci@samp.rate
...
s4 = (sad@left) / 2^(sad@bit - 1)  

timearray4 = (0:(263541-1))/sad@samp.rate
...
plot(timearray1, s1, type = 'l', col = 'blue', main = 'Normal')

plot(timearray2, s2, type = 'l', col = 'red', main = 'Angry')

plot(timearray3, s3, type = 'l', col = 'green', main = 'Excitement')

plot(timearray4, s4, type = 'l', col = 'orange', main = 'Sad')
